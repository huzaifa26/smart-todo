...
export default function Login() {
  ...
  return (
    <div style={{ backgroundImage: "linear-gradient(to right, #0E123F , rgba(14,18,63,0.8))" }} class='h-screen w-screen flex justify-center items-center'>
      <div class="px-6 py-3 rounded min-w-[300px] shadow-lg w-[21.216vw] bg-white">
        <div class="flex flex-col items-center justify-center mt-[4.271vh] mb-4">
          <h2 class="text-[clamp(32px,1.978vw,81px)] font-bold bg-[#0E123F] rounded-full"><FaUserAlt className='text-white m-4' /></h2>
        </div>
